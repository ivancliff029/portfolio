      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md sm:text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl font-light text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400">
            Stay up to date with the latest Technology news, ctf challenges and write ups, academic papers, feel free to sign up with your email.
          </p>
          <form onSubmit={handleSubmit}>
            ...
            {message && (
              <div className={`mt-4 text-sm text-left ${isError ? 'text-red-500' : 'text-green-500'}`}>
                {message}
              </div>
            )}
