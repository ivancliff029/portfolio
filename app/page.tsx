...
const AboutMe = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-20 mb-20 bg-white-200 text-gray-800">
...
const ContactForm = () => {
  return (
  <>
    <section className="contact-form flex flex-col items-center justify-center h-screen bg-white text-gray-800">
